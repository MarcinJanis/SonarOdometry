...
class Graph(nn.Module):
    ...
    def corr(self, poses, coords_phi, coords_eps, device):
        ...
        tgt_cooords_val = tgt_cooords[valid_mask] # [CHANGES]
        i_val = self.i[valid_mask] # [CHANGES]
        j_val = self.j[valid_mask] # [CHANGES]

        valid_edges_num = i_val.shape[0] # [CHANGES]

        if valid_edges_num == 0:  # [CHANGES]
            return None, None, i_val, j_val, valid_mask # [CHANGES]
