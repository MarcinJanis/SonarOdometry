    ...
    def forward(self, x, t, poses_gt, depth_gt, freeze_poses=False):
        ...
        for iter in range(self.update_iter):
            ...
            if patch_idx.shape[0] > 0: # if any edge exist
                ...
                # --- Bundle adjustement ---
                BA = BundleAdjustment(poses, self.PatchGraph.coords_r_theta, coords_phi, self.sonar_param, freeze_poses=freeze_poses)
                ...
                output_iter.append((patch_projection_error_pix, poses))
